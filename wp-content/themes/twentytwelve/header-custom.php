...
<body style="background-color:<?php echo $background_color; ?>; color:<?php echo $font_color ?>; background-image:url('<?php echo $background_main; ?>'); background-repeat:repeat; font-size:18px">

<div id="page" class="hfeed site"  style="background-image:url('<?php echo $background_panel; ?>'); background-repeat:repeat; background-color:<?php echo $panel_color; ?>; color: <?php echo $font_color ?>; ">

	<header id="masthead" class="site-header" role="banner" style="background-color:<?php echo $panel_color; ?>;">
		<hgroup>
			<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
			<h2 class="site-description"><?php bloginfo( 'description' ); ?></h2>
		</hgroup>

		<nav id="site-navigation" class="main-navigation" role="navigation" style="margin-right: 45px; ">
