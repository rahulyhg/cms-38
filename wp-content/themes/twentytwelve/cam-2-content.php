...
$android = get_the_author_meta ('android_2_link', $author_id);
$apple = get_the_author_meta ('apple_2_link', $author_id);
$standalone = get_the_author_meta ('standalone_2_link', $author_id);
?>
...
<th style="height:20px" class="tg-yw4l">Contact Number: <?php echo $contact ?></th>
</tr>
<tr style="height:60px;">
<td class="tg-yw4l"><a href="<?php echo $android ?>"><img src="http://cms.showcasestreaming.com/images/android.png" width="40" height="40" /></a>&nbsp;&nbsp;<a href="<?php echo $apple ?>"><img src="http://cms.showcasestreaming.com/images/apple.png" width="40" height="40" /></a>&nbsp;&nbsp;<a href="<?php echo $standalone ?>">Standalone Link</a></td></tr>
 <tr><td class="tg-yw4l"><?php echo $cam_updates?></td></tr>
  </table>
  </div>
